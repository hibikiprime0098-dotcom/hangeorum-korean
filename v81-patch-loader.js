(async()=>{
  if(window.__HANGEORUM_V87__||window.__HANGEORUM_V87_LOADING__)return;
  window.__HANGEORUM_V87_LOADING__=true;
  const VERSION='870';
  const files=['v82-core.js','v82-g1.js','v82-g2.js','v82-g3.js','v82-g4.js','v82-g5.js','v82-l1.js','v82-l2.js','v82-le1.js','v82-le2.js','v82-listen-ui.js','v82-ui.js','v83-progress.js','v84-tests.js','v85-learning.js','v86-grammar.js','v87-grammar-fix.js'];
  ...
  try{
    ...
    window.__HANGEORUM_V87__=true;
    document.getElementById('v81LoadError')?.remove();
  }catch(e){
    console.error('한걸음 v8.7 load failed',e);
    document.getElementById('v81LoadError')?.remove();
  ...
  }finally{window.__HANGEORUM_V87_LOADING__=false}
})();
