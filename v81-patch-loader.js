(async()=>{
  if(window.__HANGEORUM_V97__||window.__HANGEORUM_V97_LOADING__)return;
  window.__HANGEORUM_V97_LOADING__=true;
  const VERSION='970';
  ...
  try{
    ...
    window.__HANGEORUM_V97__=true;
    document.getElementById('v81LoadError')?.remove();
  }catch(e){
    console.error('한걸음 v9.7 load failed',e);
    document.getElementById('v81LoadError')?.remove();
  ...
  }finally{window.__HANGEORUM_V97_LOADING__=false}
})();
