(async()=>{
  if(window.__HANGEORUM_V82__||window.__HANGEORUM_V82_LOADING__)return;
  window.__HANGEORUM_V82_LOADING__=true;
  const VERSION='820';
  const files=['v82-core.js','v82-g1.js','v82-g2.js','v82-g3.js','v82-g4.js','v82-g5.js','v82-l1.js','v82-l2.js','v82-le1.js','v82-le2.js','v82-listen-ui.js','v82-ui.js'];
  ...
  try{
    ...
    window.__HANGEORUM_V82__=true;
    document.getElementById('v81LoadError')?.remove();
  }catch(e){
    console.error('한걸음 v8.2 load failed',e);
    document.getElementById('v81LoadError')?.remove();
  ...
  }finally{window.__HANGEORUM_V82_LOADING__=false}
})();
